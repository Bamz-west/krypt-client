            ...
            ">
                <div className="flex flex-col items-center mt-3 w-full">
                    <div className="w-full mb-6 p-2">
                        <a href={`https://ropsten.etherscan.io/address/${addressFrom}`} className="" target="_blank" rel="noopener noreferrer">
                            <p className="text-white text-base">From: {shortenAddress(addressFrom)}</p>
                        </a>
                        <a href={`https://ropsten.etherscan.io/address/${addressTo}`} className="" target="_blank" rel="noopener noreferrer">
    ...
    return (
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                ...
                <div className="flex flex-wrap justify-center items-centermt-10">
